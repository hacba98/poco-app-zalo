...
${OBJECTDIR}/FriendServicesHandler.o: FriendServicesHandler.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FriendServicesHandler.o FriendServicesHandler.cpp

${OBJECTDIR}/MyDB.o: MyDB.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyDB.o MyDB.cpp

${OBJECTDIR}/SubCache.o: SubCache.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SubCache.o SubCache.cpp

${OBJECTDIR}/SubHandler.o: SubHandler.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SubHandler.o SubHandler.cpp

${OBJECTDIR}/SubKC.o: SubKC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SubKC.o SubKC.cpp
...
${OBJECTDIR}/gen-cpp/friend_service_constants.o: gen-cpp/friend_service_constants.cpp
	${MKDIR} -p ${OBJECTDIR}/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gen-cpp/friend_service_constants.o gen-cpp/friend_service_constants.cpp

${OBJECTDIR}/gen-cpp/friend_service_types.o: gen-cpp/friend_service_types.cpp
	${MKDIR} -p ${OBJECTDIR}/gen-cpp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gen-cpp/friend_service_types.o gen-cpp/friend_service_types.cpp
